...
(function() {
  $(function() {
    $('table.adg_questions input:radio.yes').click(function() {
      return $(this).siblings('div.ansewer_field').show();
    });
    return $('table.adg_questions input:radio.no').click(function() {
      return $(this).siblings('div.ansewer_field').hide();
    });
  });
...
(function() {
  $(function() {
    return $('.use_biz_address :checkbox').click(function() {
      var billing, biz;
